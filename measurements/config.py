# List of measurements (KPIs) to import from the OKR-tracker. Each measurement
# ID is matched with existing datasets using the `wasDerivedFrom` metadata
# property, e.g. `{"name": "okr-tracker", "id": "Xy9a1c31dd"}`. If the dataset
...
MEASUREMENTS = [
    ...
    "NBMYuy4ekikNbMpcX6lb",  # Designsystem: Gjenbruk av komponenter i kode
